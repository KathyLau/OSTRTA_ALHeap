...
public class ALMaxHeap {
    ...
    else return _heap.get(0); // first element of the array is root, aka max
    } //O(1)
    ...
    public Integer removeMax() {
        ...
        int pos = 0;
        int maxPos; //holder for maxChildPos

        while (pos < _heap.size()) {
          maxPos = maxChildPos(pos);
          if (maxPos == -1) break;
          else if (end.compareTo(_heap.get(maxPos))>= 0) break;
          else {
            swap(pos, maxPos);
            pos = maxPos;
          }
